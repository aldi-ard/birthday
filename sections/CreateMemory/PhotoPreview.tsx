    ...
    >
      <div className="w-full max-w-md ">
        ...
        <div className="relative aspect-[9/16] overflow-hidden rounded-3xl bg-white shadow-2xl">
          ...
          {/* Bottom */}
         <div className="absolute bottom-10 left-0 right-0 px-6 text-center text-white">
        ...
        <div className="mt-5 flex gap-3">
          <button
            onClick={onRetake}
            className="flex-1 rounded-full border border-white/30 px-5 py-3 text-sm text-white backdrop-blur-md transition hover:bg-white/10"
          >
            Retake
          </button>
          ...
          <button
            onClick={onShare}
            className="flex-1 rounded-full bg-white px-5 py-3 text-sm font-medium text-pink-800 transition active:scale-95"
          >
            Share ♡
          </button>
            <button
